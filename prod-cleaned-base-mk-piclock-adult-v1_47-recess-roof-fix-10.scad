// mk-piclock-adult V1.46 simplified production model
...
// Round screw-shielding bump over the upper-left touch screw, matching the
// kids-clock design: a full 45-degree frustum. Its radius decreases by
// exactly its outward projection, so no horizontal underside forms in the
// speaker-side-down print orientation.
touch_bump_h = 1.60;
