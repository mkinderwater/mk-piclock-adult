...
const baseStatus = {
    ...
    app_version: 'mk-clock-adult-1.2.40',
    uptime_seconds: 1,
    oled_ok: true,
    oled_color: 'green',
    display_mode: 'clock',
    ...
    weather: {
        ...
        observed_at: 1,
        slots: [
            {kind: 'room', label: 'ROOM', temperature_c: 19, temperature_available: false, icon: 2},
...
renderStatus({
    ...
    weather: {
        ...
        current_temperature_c: 0,
        slots: [
            {kind: 'room', label: 'ROOM', temperature_c: 0, temperature_available: false, icon: 0},
